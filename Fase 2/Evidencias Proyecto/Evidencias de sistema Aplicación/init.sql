...
ALTER TABLE USUARIO ADD CONSTRAINT fk_contacto_em FOREIGN KEY (contacto_emergencia_ID) REFERENCES CONTACTO_EMERGENCIA(contacto_emergencia_ID);
...
ALTER TABLE SOPORTE ADD CONSTRAINT fk_cat_sop FOREIGN KEY (categoria_soporte_ID) REFERENCES USUARIO(categoria_soporte_ID);
