<!-- converted from PLAZA_DIEGO_1.1_APT122_AutoevaluacionCompetenciasFase1.docx -->
...
| Escuela | Escuela |
| --- | --- |
| Nombre completo | Diego Matias Plaza Martinez |
| Plan de Estudio | Ingeniería En informática/ Código: 1446114/ ID: 2131 |
| Año de ingreso | 2023 |
| Competencias Perfil de egreso | Nivel de logro | Nivel de logro | Nivel de logro | Nivel de logro | Nivel de logro | Comentarios |
| --- | --- | --- | --- | --- | --- | --- |
| Competencias Perfil de egreso | Excelente Dominio | Alto Dominio | Dominio Aceptable | Dominio Insuficiente | Dominio no logrado | Comentarios |
| Levantamiento y análisis de requerimientos |  | x |  |  |  |  |
| Desarrollo de sistemas computacionales |  | x |  |  |  |  |
| Integración de tecnologías y sistemas |  | x |  |  |  |  |
| Gestión y modelamiento de bases de datos | x |  |  |  |  |  |
| Seguridad en sistemas computacionales | x |  |  |  |  |  |
| Gestión de proyectos |  |  | x |  |  |  |
| Documentación de las distintas etapas. |  | x |  |  |  |  |
| Aseguramiento de la calidad del software |  |  | x |  |  |  |